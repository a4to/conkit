...
get_latest_version()
{
  latest_version=$(curl -s https://api.github.com/repos/conkit/$REPO/releases/latest | grep -oP '"tarball_url": ".*/tarball/v\K([^/]*)(?=")')
...
ARCHIVE_URL="https://github.com/a4to/$REPO/releases/download/v${VERSION}/${REPO}_${VERSION}_linux_${ARCH}.tar.gz"
...
log "\nconkit-server is installed to $INSTALL_PATH\n"
