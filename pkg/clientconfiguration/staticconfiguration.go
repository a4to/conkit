...
func (s *StaticClientConfigurationManager) GetConfiguration(clientInfo *conkit.ClientInfo) *conkit.ClientConfiguration {
	var matchedConf []*conkit.ClientConfiguration
	...
	var conf *conkit.ClientConfiguration
