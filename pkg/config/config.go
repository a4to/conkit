...
import (
	...
	redisLiveKit "github.com/a4to/protocol/redis"
...
type RoomConfig struct {
	...
	RoomConfigurations           map[string]*conkit.RoomConfiguration `yaml:"room_configurations,omitempty"`
}
...
func SetLogger(l logger.Logger) {
	logger.SetLogger(l, "conkit")
}

func InitLoggerFromConfig(config *LoggingConfig) {
	logger.InitFromConfig(&config.Config, "conkit")
}
