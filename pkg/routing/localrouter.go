...
func (r *LocalRouter) GetNodeForRoom(_ context.Context, _ conkit.RoomName) (*conkit.Node, error) {
	return r.currentNode.Clone(), nil
}

func (r *LocalRouter) SetNodeForRoom(_ context.Context, _ conkit.RoomName, _ conkit.NodeID) error {
	return nil
}

func (r *LocalRouter) ClearRoomState(_ context.Context, _ conkit.RoomName) error {
	return nil
}
...
func (r *LocalRouter) GetNode(nodeID conkit.NodeID) (*conkit.Node, error) {
...
func (r *LocalRouter) ListNodes() ([]*conkit.Node, error) {
	return []*conkit.Node{
		r.currentNode.Clone(),
	}, nil
}

func (r *LocalRouter) CreateRoom(ctx context.Context, req *conkit.CreateRoomRequest) (res *conkit.Room, err error) {
	return r.CreateRoomWithNodeID(ctx, req, r.currentNode.NodeID())
}

func (r *LocalRouter) CreateRoomWithNodeID(ctx context.Context, req *conkit.CreateRoomRequest, nodeID conkit.NodeID) (res *conkit.Room, err error) {
	return r.roomManagerClient.CreateRoom(ctx, nodeID, req)
}

func (r *LocalRouter) StartParticipantSignal(ctx context.Context, roomName conkit.RoomName, pi ParticipantInit) (res StartParticipantSignalResults, err error) {
	return r.StartParticipantSignalWithNodeID(ctx, roomName, pi, r.currentNode.NodeID())
}

func (r *LocalRouter) StartParticipantSignalWithNodeID(ctx context.Context, roomName conkit.RoomName, pi ParticipantInit, nodeID conkit.NodeID) (res StartParticipantSignalResults, err error) {
