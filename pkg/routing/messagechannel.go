...
func NewDefaultMessageChannel(connectionID conkit.ConnectionID) *MessageChannel {
	return NewMessageChannel(connectionID, DefaultMessageChannelSize)
}

func NewMessageChannel(connectionID conkit.ConnectionID, size int) *MessageChannel {
...
func (m *MessageChannel) ConnectionID() conkit.ConnectionID {
