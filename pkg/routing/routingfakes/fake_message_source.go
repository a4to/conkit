...
type FakeMessageSource struct {
	...
	ConnectionIDStub        func() conkit.ConnectionID
...
func (fake *FakeMessageSource) ConnectionID() conkit.ConnectionID {
...
func (fake *FakeMessageSource) ConnectionIDCalls(stub func() conkit.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
	fake.ConnectionIDStub = stub
}

func (fake *FakeMessageSource) ConnectionIDReturns(result1 conkit.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
...
func (fake *FakeMessageSource) ConnectionIDReturnsOnCall(i int, result1 conkit.ConnectionID) {
	fake.connectionIDMutex.Lock()
	defer fake.connectionIDMutex.Unlock()
	fake.ConnectionIDStub = nil
