...
type FakeRoomManagerClient struct {
	...
	CreateRoomStub        func(context.Context, conkit.NodeID, *conkit.CreateRoomRequest, ...psrpc.RequestOption) (*conkit.Room, error)
	createRoomMutex       sync.RWMutex
	createRoomArgsForCall []struct {
		arg1 context.Context
		arg2 conkit.NodeID
		arg3 *conkit.CreateRoomRequest
...
func (fake *FakeRoomManagerClient) CreateRoom(arg1 context.Context, arg2 conkit.NodeID, arg3 *conkit.CreateRoomRequest, arg4 ...psrpc.RequestOption) (*conkit.Room, error) {
...
func (fake *FakeRoomManagerClient) CreateRoomCalls(stub func(context.Context, conkit.NodeID, *conkit.CreateRoomRequest, ...psrpc.RequestOption) (*conkit.Room, error)) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
	fake.CreateRoomStub = stub
}

func (fake *FakeRoomManagerClient) CreateRoomArgsForCall(i int) (context.Context, conkit.NodeID, *conkit.CreateRoomRequest, []psrpc.RequestOption) {
	fake.createRoomMutex.RLock()
	defer fake.createRoomMutex.RUnlock()
...
func (fake *FakeRoomManagerClient) CreateRoomReturns(result1 *conkit.Room, result2 error) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
...
func (fake *FakeRoomManagerClient) CreateRoomReturnsOnCall(i int, result1 *conkit.Room, result2 error) {
	fake.createRoomMutex.Lock()
	defer fake.createRoomMutex.Unlock()
	fake.CreateRoomStub = nil
