...
func (c ClientInfo) isGo() bool {
	return c.ClientInfo != nil && c.ClientInfo.Sdk == conkit.ClientInfo_GO
}
...
func (c ClientInfo) SupportsCodecChange() bool {
	return c.ClientInfo != nil && c.ClientInfo.Sdk != conkit.ClientInfo_GO && c.ClientInfo.Sdk != conkit.ClientInfo_UNKNOWN
}

func (c ClientInfo) CanHandleReconnectResponse() bool {
	if c.Sdk == conkit.ClientInfo_JS {
...
func (c ClientInfo) SupportsICETCP() bool {
	...
	if c.ClientInfo.Sdk == conkit.ClientInfo_GO {
		// Go does not support active TCP
		return false
	}
	if c.ClientInfo.Sdk == conkit.ClientInfo_SWIFT {
...
func (c ClientInfo) SupportTrackSubscribedEvent() bool {
	return !(c.ClientInfo.GetSdk() == conkit.ClientInfo_RUST && c.ClientInfo.GetProtocol() < 10)
}
...
func (c ClientInfo) SupportSctpZeroChecksum() bool {
	return !(c.ClientInfo.GetSdk() == conkit.ClientInfo_UNKNOWN ||
