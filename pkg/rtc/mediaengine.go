...
func registerCodecs(me *webrtc.MediaEngine, codecs []*conkit.Codec, rtcpFeedback RTCPFeedbackConfig, filterOutH264HighProfile bool) error {
...
func createMediaEngine(codecs []*conkit.Codec, config DirectionConfig, filterOutH264HighProfile bool) (*webrtc.MediaEngine, error) {
...
func IsCodecEnabled(codecs []*conkit.Codec, cap webrtc.RTPCodecCapability) bool {
...
func selectAlternativeVideoCodec(enabledCodecs []*conkit.Codec) string {
