...
func (t *SubscribedTrack) Bound(err error) {
	...
	if err == nil && t.MediaTrack().Kind() == conkit.TrackType_VIDEO {
		...
		if t.settings != nil {
			...
			if t.params.AdaptiveStream {
				t.settings = &conkit.UpdateTrackSettings{Quality: conkit.VideoQuality_LOW}
			} else {
				t.settings = &conkit.UpdateTrackSettings{Quality: conkit.VideoQuality_HIGH}
			}
		}
...
func (t *SubscribedTrack) ID() conkit.TrackID {
	return conkit.TrackID(t.params.DownTrack.ID())
}

func (t *SubscribedTrack) PublisherID() conkit.ParticipantID {
	return t.params.PublisherID
}

func (t *SubscribedTrack) PublisherIdentity() conkit.ParticipantIdentity {
...
func (t *SubscribedTrack) SubscriberID() conkit.ParticipantID {
	return t.params.Subscriber.ID()
}

func (t *SubscribedTrack) SubscriberIdentity() conkit.ParticipantIdentity {
...
func (t *SubscribedTrack) UpdateSubscriberSettings(settings *conkit.UpdateTrackSettings, isImmediate bool) {
	t.settingsLock.Lock()
