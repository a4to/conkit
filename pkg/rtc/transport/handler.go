...
type Handler interface {
	OnICECandidate(c *webrtc.ICECandidate, target conkit.SignalTarget) error
	OnInitialConnected()
	OnFullyEstablished()
	...
	OnDataPacket(kind conkit.DataPacket_Kind, data []byte)
...
func (h UnimplementedHandler) OnICECandidate(c *webrtc.ICECandidate, target conkit.SignalTarget) error {
...
func (h UnimplementedHandler) OnDataPacket(kind conkit.DataPacket_Kind, data []byte)             {}
