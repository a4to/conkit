...
type FakeHandler struct {
	...
	OnDataPacketStub        func(conkit.DataPacket_Kind, []byte)
	...
	OnICECandidateStub        func(*webrtc.ICECandidate, conkit.SignalTarget) error
...
func (fake *FakeHandler) OnDataPacket(arg1 conkit.DataPacket_Kind, arg2 []byte) {
	var arg2Copy []byte
	if arg2 != nil {
...
func (fake *FakeHandler) OnDataPacketCalls(stub func(conkit.DataPacket_Kind, []byte)) {
	fake.onDataPacketMutex.Lock()
	defer fake.onDataPacketMutex.Unlock()
	fake.OnDataPacketStub = stub
}

func (fake *FakeHandler) OnDataPacketArgsForCall(i int) (conkit.DataPacket_Kind, []byte) {
	fake.onDataPacketMutex.RLock()
	defer fake.onDataPacketMutex.RUnlock()
...
func (fake *FakeHandler) OnICECandidate(arg1 *webrtc.ICECandidate, arg2 conkit.SignalTarget) error {
...
func (fake *FakeHandler) OnICECandidateCalls(stub func(*webrtc.ICECandidate, conkit.SignalTarget) error) {
	fake.onICECandidateMutex.Lock()
	defer fake.onICECandidateMutex.Unlock()
	fake.OnICECandidateStub = stub
}

func (fake *FakeHandler) OnICECandidateArgsForCall(i int) (*webrtc.ICECandidate, conkit.SignalTarget) {
	fake.onICECandidateMutex.RLock()
	defer fake.onICECandidateMutex.RUnlock()
