...
func (fake *FakeParticipant) GetPublishedTrack(arg1 conkit.TrackID) types.MediaTrack {
...
func (fake *FakeParticipant) GetPublishedTrackCalls(stub func(conkit.TrackID) types.MediaTrack) {
	fake.getPublishedTrackMutex.Lock()
	defer fake.getPublishedTrackMutex.Unlock()
	fake.GetPublishedTrackStub = stub
}

func (fake *FakeParticipant) GetPublishedTrackArgsForCall(i int) conkit.TrackID {
	fake.getPublishedTrackMutex.RLock()
	defer fake.getPublishedTrackMutex.RUnlock()
...
func (fake *FakeParticipant) HasPermission(arg1 conkit.TrackID, arg2 conkit.ParticipantIdentity) bool {
...
func (fake *FakeParticipant) HasPermissionCalls(stub func(conkit.TrackID, conkit.ParticipantIdentity) bool) {
	fake.hasPermissionMutex.Lock()
	defer fake.hasPermissionMutex.Unlock()
	fake.HasPermissionStub = stub
}

func (fake *FakeParticipant) HasPermissionArgsForCall(i int) (conkit.TrackID, conkit.ParticipantIdentity) {
	fake.hasPermissionMutex.RLock()
	defer fake.hasPermissionMutex.RUnlock()
...
func (fake *FakeParticipant) ID() conkit.ParticipantID {
	fake.iDMutex.Lock()
...
func (fake *FakeParticipant) IDCalls(stub func() conkit.ParticipantID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = stub
}

func (fake *FakeParticipant) IDReturns(result1 conkit.ParticipantID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeParticipant) IDReturnsOnCall(i int, result1 conkit.ParticipantID) {
	fake.iDMutex.Lock()
	defer fake.iDMutex.Unlock()
	fake.IDStub = nil
...
func (fake *FakeParticipant) Identity() conkit.ParticipantIdentity {
...
func (fake *FakeParticipant) IdentityCalls(stub func() conkit.ParticipantIdentity) {
	fake.identityMutex.Lock()
	defer fake.identityMutex.Unlock()
	fake.IdentityStub = stub
}

func (fake *FakeParticipant) IdentityReturns(result1 conkit.ParticipantIdentity) {
	fake.identityMutex.Lock()
	defer fake.identityMutex.Unlock()
...
func (fake *FakeParticipant) IdentityReturnsOnCall(i int, result1 conkit.ParticipantIdentity) {
	fake.identityMutex.Lock()
	defer fake.identityMutex.Unlock()
	fake.IdentityStub = nil
...
func (fake *FakeParticipant) Kind() conkit.ParticipantInfo_Kind {
	fake.kindMutex.Lock()
...
func (fake *FakeParticipant) KindCalls(stub func() conkit.ParticipantInfo_Kind) {
	fake.kindMutex.Lock()
	defer fake.kindMutex.Unlock()
	fake.KindStub = stub
}

func (fake *FakeParticipant) KindReturns(result1 conkit.ParticipantInfo_Kind) {
	fake.kindMutex.Lock()
	defer fake.kindMutex.Unlock()
	fake.KindStub = nil
...
func (fake *FakeParticipant) KindReturnsOnCall(i int, result1 conkit.ParticipantInfo_Kind) {
	fake.kindMutex.Lock()
	defer fake.kindMutex.Unlock()
	fake.KindStub = nil
...
func (fake *FakeParticipant) OnMetrics(arg1 func(types.Participant, *conkit.DataPacket)) {
...
func (fake *FakeParticipant) OnMetricsCalls(stub func(func(types.Participant, *conkit.DataPacket))) {
	fake.onMetricsMutex.Lock()
	defer fake.onMetricsMutex.Unlock()
	fake.OnMetricsStub = stub
}

func (fake *FakeParticipant) OnMetricsArgsForCall(i int) func(types.Participant, *conkit.DataPacket) {
	fake.onMetricsMutex.RLock()
	defer fake.onMetricsMutex.RUnlock()
...
func (fake *FakeParticipant) State() conkit.ParticipantInfo_State {
...
func (fake *FakeParticipant) StateCalls(stub func() conkit.ParticipantInfo_State) {
	fake.stateMutex.Lock()
	defer fake.stateMutex.Unlock()
	fake.StateStub = stub
}

func (fake *FakeParticipant) StateReturns(result1 conkit.ParticipantInfo_State) {
	fake.stateMutex.Lock()
	defer fake.stateMutex.Unlock()
	fake.StateStub = nil
...
func (fake *FakeParticipant) StateReturnsOnCall(i int, result1 conkit.ParticipantInfo_State) {
	fake.stateMutex.Lock()
	defer fake.stateMutex.Unlock()
	fake.StateStub = nil
...
func (fake *FakeParticipant) SubscriptionPermission() (*conkit.SubscriptionPermission, utils.TimedVersion) {
...
func (fake *FakeParticipant) SubscriptionPermissionCalls(stub func() (*conkit.SubscriptionPermission, utils.TimedVersion)) {
	fake.subscriptionPermissionMutex.Lock()
	defer fake.subscriptionPermissionMutex.Unlock()
	fake.SubscriptionPermissionStub = stub
}

func (fake *FakeParticipant) SubscriptionPermissionReturns(result1 *conkit.SubscriptionPermission, result2 utils.TimedVersion) {
	fake.subscriptionPermissionMutex.Lock()
	defer fake.subscriptionPermissionMutex.Unlock()
...
func (fake *FakeParticipant) SubscriptionPermissionReturnsOnCall(i int, result1 *conkit.SubscriptionPermission, result2 utils.TimedVersion) {
	fake.subscriptionPermissionMutex.Lock()
	defer fake.subscriptionPermissionMutex.Unlock()
	fake.SubscriptionPermissionStub = nil
...
func (fake *FakeParticipant) ToProto() *conkit.ParticipantInfo {
...
func (fake *FakeParticipant) ToProtoCalls(stub func() *conkit.ParticipantInfo) {
	fake.toProtoMutex.Lock()
	defer fake.toProtoMutex.Unlock()
	fake.ToProtoStub = stub
}

func (fake *FakeParticipant) ToProtoReturns(result1 *conkit.ParticipantInfo) {
	fake.toProtoMutex.Lock()
	defer fake.toProtoMutex.Unlock()
...
func (fake *FakeParticipant) ToProtoReturnsOnCall(i int, result1 *conkit.ParticipantInfo) {
	fake.toProtoMutex.Lock()
	defer fake.toProtoMutex.Unlock()
	fake.ToProtoStub = nil
...
func (fake *FakeParticipant) UpdateSubscriptionPermission(arg1 *conkit.SubscriptionPermission, arg2 utils.TimedVersion, arg3 func(participantID conkit.ParticipantID) types.LocalParticipant) error {
...
func (fake *FakeParticipant) UpdateSubscriptionPermissionCalls(stub func(*conkit.SubscriptionPermission, utils.TimedVersion, func(participantID conkit.ParticipantID) types.LocalParticipant) error) {
	fake.updateSubscriptionPermissionMutex.Lock()
	defer fake.updateSubscriptionPermissionMutex.Unlock()
	fake.UpdateSubscriptionPermissionStub = stub
}

func (fake *FakeParticipant) UpdateSubscriptionPermissionArgsForCall(i int) (*conkit.SubscriptionPermission, utils.TimedVersion, func(participantID conkit.ParticipantID) types.LocalParticipant) {
	fake.updateSubscriptionPermissionMutex.RLock()
	defer fake.updateSubscriptionPermissionMutex.RUnlock()
