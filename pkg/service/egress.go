...
func (s *EgressService) StartRoomCompositeEgress(ctx context.Context, req *conkit.RoomCompositeEgressRequest) (*conkit.EgressInfo, error) {
	fields := []interface{}{
		"room", req.RoomName,
	...
	ei, err := s.startEgress(ctx, conkit.RoomName(req.RoomName), &rpc.StartEgressRequest{
...
func (s *EgressService) StartWebEgress(ctx context.Context, req *conkit.WebEgressRequest) (*conkit.EgressInfo, error) {
	fields := []interface{}{
		"url", req.Url,
		"outputType", egress.GetOutputType(req),
	}
...
func (s *EgressService) StartParticipantEgress(ctx context.Context, req *conkit.ParticipantEgressRequest) (*conkit.EgressInfo, error) {
	fields := []interface{}{
		"room", req.RoomName,
...
func (s *EgressService) StartTrackCompositeEgress(ctx context.Context, req *conkit.TrackCompositeEgressRequest) (*conkit.EgressInfo, error) {
	fields := []interface{}{
		"room", req.RoomName,
...
func (s *EgressService) StartTrackEgress(ctx context.Context, req *conkit.TrackEgressRequest) (*conkit.EgressInfo, error) {
...
func (s *EgressService) startEgress(ctx context.Context, roomName conkit.RoomName, req *rpc.StartEgressRequest) (*conkit.EgressInfo, error) {
...
func (s *EgressService) UpdateLayout(ctx context.Context, req *conkit.UpdateLayoutRequest) (*conkit.EgressInfo, error) {
	...
	_, err = s.roomService.UpdateParticipant(ctx, &conkit.UpdateParticipantRequest{
		Room:     info.RoomName,
...
func (s *EgressService) UpdateStream(ctx context.Context, req *conkit.UpdateStreamRequest) (*conkit.EgressInfo, error) {
	...
	if err != nil {
		...
		switch info.Status {
		case conkit.EgressStatus_EGRESS_STARTING,
			conkit.EgressStatus_EGRESS_ACTIVE:
			return nil, err
		default:
...
func (s *EgressService) ListEgress(ctx context.Context, req *conkit.ListEgressRequest) (*conkit.ListEgressResponse, error) {
	if req.RoomName != "" {
...
func (s *EgressService) StopEgress(ctx context.Context, req *conkit.StopEgressRequest) (*conkit.EgressInfo, error) {
