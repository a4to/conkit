...
func (s *IOInfoService) CreateIngress(ctx context.Context, info *conkit.IngressInfo) (*emptypb.Empty, error) {
...
func (s *IOInfoService) loadIngressFromInfoRequest(req *rpc.GetIngressInfoRequest) (info *conkit.IngressInfo, err error) {
	if req.IngressId != "" {
...
func (s *IOInfoService) UpdateIngressState(ctx context.Context, req *rpc.UpdateIngressStateRequest) (*emptypb.Empty, error) {
	...
	if info.State.Status != req.State.Status {
		...
		case conkit.IngressState_ENDPOINT_ERROR,
			conkit.IngressState_ENDPOINT_INACTIVE,
			conkit.IngressState_ENDPOINT_COMPLETE:
		...
		case conkit.IngressState_ENDPOINT_PUBLISHING:
