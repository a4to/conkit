...
import (
	...
	"github.com/a4to/protocol/egress"
...
func (s *RoomService) CreateRoom(ctx context.Context, req *conkit.CreateRoomRequest) (*conkit.Room, error) {
	...
	err := s.roomAllocator.SelectRoomNode(ctx, conkit.RoomName(req.Name), conkit.NodeID(req.NodeId))
	if err != nil {
		return nil, err
	}
...
func (s *RoomService) ListRooms(ctx context.Context, req *conkit.ListRoomsRequest) (*conkit.ListRoomsResponse, error) {
	...
	var names []conkit.RoomName
	if len(req.Names) > 0 {
		names = conkit.StringsAsIDs[conkit.RoomName](req.Names)
	}
...
func (s *RoomService) DeleteRoom(ctx context.Context, req *conkit.DeleteRoomRequest) (*conkit.DeleteRoomResponse, error) {
	RecordRequest(ctx, req)
	...
	_, _, err := s.roomStore.LoadRoom(ctx, conkit.RoomName(req.Room), false)
	if err != nil {
		return nil, err
	}

	// ensure at least one node is available to handle the request
	_, err = s.router.CreateRoom(ctx, &conkit.CreateRoomRequest{Name: req.Room})
	if err != nil {
		return nil, err
	}

	_, err = s.roomClient.DeleteRoom(ctx, s.topicFormatter.RoomTopic(ctx, conkit.RoomName(req.Room)), req)
	if err != nil {
		return nil, err
	}

	err = s.roomStore.DeleteRoom(ctx, conkit.RoomName(req.Room))
	res := &conkit.DeleteRoomResponse{}
	RecordResponse(ctx, res)
	return res, err
}

func (s *RoomService) ListParticipants(ctx context.Context, req *conkit.ListParticipantsRequest) (*conkit.ListParticipantsResponse, error) {
	RecordRequest(ctx, req)

	AppendLogFields(ctx, "room", req.Room)
	if err := EnsureAdminPermission(ctx, conkit.RoomName(req.Room)); err != nil {
		return nil, twirpAuthError(err)
	}

	participants, err := s.roomStore.ListParticipants(ctx, conkit.RoomName(req.Room))
	if err != nil {
		return nil, err
	}

	res := &conkit.ListParticipantsResponse{
...
func (s *RoomService) GetParticipant(ctx context.Context, req *conkit.RoomParticipantIdentity) (*conkit.ParticipantInfo, error) {
	RecordRequest(ctx, req)
	...
	participant, err := s.roomStore.LoadParticipant(ctx, conkit.RoomName(req.Room), conkit.ParticipantIdentity(req.Identity))
	if err != nil {
		return nil, err
	}
...
func (s *RoomService) RemoveParticipant(ctx context.Context, req *conkit.RoomParticipantIdentity) (*conkit.RemoveParticipantResponse, error) {
	RecordRequest(ctx, req)
	...
	if _, err := s.roomStore.LoadParticipant(ctx, conkit.RoomName(req.Room), conkit.ParticipantIdentity(req.Identity)); err == ErrParticipantNotFound {
		return nil, twirp.NotFoundError("participant not found")
	}

	res, err := s.participantClient.RemoveParticipant(ctx, s.topicFormatter.ParticipantTopic(ctx, conkit.RoomName(req.Room), conkit.ParticipantIdentity(req.Identity)), req)
	RecordResponse(ctx, res)
	return res, err
}

func (s *RoomService) MutePublishedTrack(ctx context.Context, req *conkit.MuteRoomTrackRequest) (*conkit.MuteRoomTrackResponse, error) {
	RecordRequest(ctx, req)
	...
	res, err := s.participantClient.MutePublishedTrack(ctx, s.topicFormatter.ParticipantTopic(ctx, conkit.RoomName(req.Room), conkit.ParticipantIdentity(req.Identity)), req)
	RecordResponse(ctx, res)
	return res, err
}

func (s *RoomService) UpdateParticipant(ctx context.Context, req *conkit.UpdateParticipantRequest) (*conkit.ParticipantInfo, error) {
	...
	res, err := s.participantClient.UpdateParticipant(ctx, s.topicFormatter.ParticipantTopic(ctx, conkit.RoomName(req.Room), conkit.ParticipantIdentity(req.Identity)), req)
	RecordResponse(ctx, res)
	return res, err
}

func (s *RoomService) UpdateSubscriptions(ctx context.Context, req *conkit.UpdateSubscriptionsRequest) (*conkit.UpdateSubscriptionsResponse, error) {
	RecordRequest(ctx, req)
	...
	res, err := s.participantClient.UpdateSubscriptions(ctx, s.topicFormatter.ParticipantTopic(ctx, conkit.RoomName(req.Room), conkit.ParticipantIdentity(req.Identity)), req)
	RecordResponse(ctx, res)
	return res, err
}

func (s *RoomService) SendData(ctx context.Context, req *conkit.SendDataRequest) (*conkit.SendDataResponse, error) {
	RecordRequest(ctx, redactSendDataRequest(req))

	roomName := conkit.RoomName(req.Room)
	...
	res, err := s.roomClient.SendData(ctx, s.topicFormatter.RoomTopic(ctx, conkit.RoomName(req.Room)), req)
	RecordResponse(ctx, res)
	return res, err
}

func (s *RoomService) UpdateRoomMetadata(ctx context.Context, req *conkit.UpdateRoomMetadataRequest) (*conkit.Room, error) {
	...
	room, err := s.roomClient.UpdateRoomMetadata(ctx, s.topicFormatter.RoomTopic(ctx, conkit.RoomName(req.Room)), req)
	if err != nil {
		return nil, err
	}
...
func redactCreateRoomRequest(req *conkit.CreateRoomRequest) *conkit.CreateRoomRequest {
...
func redactUpdateParticipantRequest(req *conkit.UpdateParticipantRequest) *conkit.UpdateParticipantRequest {
...
func redactSendDataRequest(req *conkit.SendDataRequest) *conkit.SendDataRequest {
	if len(req.Data) == 0 {
		return req
	}
...
func redactUpdateRoomMetadataRequest(req *conkit.UpdateRoomMetadataRequest) *conkit.UpdateRoomMetadataRequest {
	if req.Metadata == "" {
		return req
	}
