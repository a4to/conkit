...
func RecordRequest(ctx context.Context, request proto.Message) {
	...
	a, ok := ctx.Value(twirpTelemetryKey{}).(*conkit.APICallInfo)
	if !ok || a == nil {
		return
	}
	...
	case *conkit.CreateRoomRequest:
		a.Request = &conkit.APICallRequest{
			Message: &conkit.APICallRequest_CreateRoomRequest{
				CreateRoomRequest: msg,
			},
		}
		a.RoomName = msg.GetName()

	case *conkit.ListRoomsRequest:
		a.Request = &conkit.APICallRequest{
			Message: &conkit.APICallRequest_ListRoomsRequest{
				ListRoomsRequest: msg,
			},
		}

	case *conkit.DeleteRoomRequest:
		a.Request = &conkit.APICallRequest{
			Message: &conkit.APICallRequest_DeleteRoomRequest{
				DeleteRoomRequest: msg,
			},
		}
		a.RoomName = msg.GetRoom()

	case *conkit.ListParticipantsRequest:
		a.Request = &conkit.APICallRequest{
			Message: &conkit.APICallRequest_ListParticipantsRequest{
				ListParticipantsRequest: msg,
			},
		}
		a.RoomName = msg.GetRoom()

	case *conkit.RoomParticipantIdentity:
		a.Request = &conkit.APICallRequest{
			Message: &conkit.APICallRequest_RoomParticipantIdentity{
	...
	case *conkit.MuteRoomTrackRequest:
		a.Request = &conkit.APICallRequest{
			Message: &conkit.APICallRequest_MuteRoomTrackRequest{
	...
	case *conkit.UpdateParticipantRequest:
		a.Request = &conkit.APICallRequest{
			Message: &conkit.APICallRequest_UpdateParticipantRequest{
	...
	case *conkit.UpdateSubscriptionsRequest:
		a.Request = &conkit.APICallRequest{
			Message: &conkit.APICallRequest_UpdateSubscriptionsRequest{
	...
	case *conkit.SendDataRequest:
		a.Request = &conkit.APICallRequest{
			Message: &conkit.APICallRequest_SendDataRequest{
				SendDataRequest: msg,
			},
		}
		a.RoomName = msg.GetRoom()

	case *conkit.UpdateRoomMetadataRequest:
		a.Request = &conkit.APICallRequest{
			Message: &conkit.APICallRequest_UpdateRoomMetadataRequest{
