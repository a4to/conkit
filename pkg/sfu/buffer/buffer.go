...
import (
	...
	"github.com/a4to/mediatransportutil/pkg/nack"
...
type Buffer struct {
	...
	onFpsChanged       func()
	onFinalRtpStats    func(*conkit.RTPStats)
...
func (b *Buffer) SetSenderReportData(rtpTime uint32, ntpTime uint64, packets uint32, octets uint32) {
	b.RLock()
	srData := &conkit.RTCPSenderReportState{
...
func (b *Buffer) GetSenderReportData() *conkit.RTCPSenderReportState {
	b.RLock()
	defer b.RUnlock()
...
func (b *Buffer) OnFinalRtpStats(fn func(*conkit.RTPStats)) {
	b.Lock()
	b.onFinalRtpStats = fn
	b.Unlock()
}

func (b *Buffer) getOnFinalRtpStats() func(*conkit.RTPStats) {
	b.RLock()
	defer b.RUnlock()
...
func (b *Buffer) GetStats() *conkit.RTPStats {
	b.RLock()
	defer b.RUnlock()
