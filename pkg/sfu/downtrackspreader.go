...
type DownTrackSpreader struct {
	...
	downTracks       map[conkit.ParticipantID]TrackSender
...
func NewDownTrackSpreader(params DownTrackSpreaderParams) *DownTrackSpreader {
	d := &DownTrackSpreader{
		params:     params,
		downTracks: make(map[conkit.ParticipantID]TrackSender),
	}
...
func (d *DownTrackSpreader) ResetAndGetDownTracks() []TrackSender {
	...
	d.downTracks = make(map[conkit.ParticipantID]TrackSender)
...
func (d *DownTrackSpreader) Free(subscriberID conkit.ParticipantID) {
	d.downTrackMu.Lock()
	defer d.downTrackMu.Unlock()
...
func (d *DownTrackSpreader) HasDownTrack(subscriberID conkit.ParticipantID) bool {
	d.downTrackMu.RLock()
	defer d.downTrackMu.RUnlock()
