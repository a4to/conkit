...
func RTCPSenderReportPropagationDelay(rsrs *conkit.RTCPSenderReportState, passThrough bool) time.Duration {
	if passThrough {
		return 0
	}
...
type rtpStatsBase struct {
	*rtpStatsBaseLite
	...
	srFirst  *conkit.RTCPSenderReportState
	srNewest *conkit.RTCPSenderReportState
...
func (r *rtpStatsBase) maybeAdjustFirstPacketTime(srData *conkit.RTCPSenderReportState, tsOffset uint64, extStartTS uint64) (err error, loggingFields []interface{}) {
...
func (r *rtpStatsBase) getDrift(extStartTS, extHighestTS uint64) (
	packetDrift *conkit.RTPDrift,
	ntpReportDrift *conkit.RTPDrift,
	receivedReportDrift *conkit.RTPDrift,
	rebasedReportDrift *conkit.RTPDrift,
) {
	if r.firstTime != 0 {
...
func AggregateRTPStats(statsList []*conkit.RTPStats) *conkit.RTPStats {
...
func ReconcileRTPStatsWithRTX(primaryStats *conkit.RTPStats, rtxStats *conkit.RTPStats) *conkit.RTPStats {
