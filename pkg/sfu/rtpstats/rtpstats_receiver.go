...
func (r *RTPStatsReceiver) getExtendedSenderReport(srData *conkit.RTCPSenderReportState) *conkit.RTCPSenderReportState {
	tsCycles := uint64(0)
	if r.srNewest != nil {
...
func (r *RTPStatsReceiver) checkOutOfOrderSenderReport(srData *conkit.RTCPSenderReportState) bool {
...
func (r *RTPStatsReceiver) checkRTPClockSkewForSenderReport(srData *conkit.RTCPSenderReportState) {
	if r.srNewest == nil {
		return
	}
...
func (r *RTPStatsReceiver) checkRTPClockSkewAgainstMediaPathForSenderReport(srData *conkit.RTCPSenderReportState) {
	if r.highestTime == 0 {
		return
	}
...
func (r *RTPStatsReceiver) updatePropagationDelayAndRecordSenderReport(srData *conkit.RTCPSenderReportState) {
...
func (r *RTPStatsReceiver) SetRtcpSenderReportData(srData *conkit.RTCPSenderReportState) bool {
	r.lock.Lock()
	defer r.lock.Unlock()
...
func (r *RTPStatsReceiver) GetRtcpSenderReportData() *conkit.RTCPSenderReportState {
	r.lock.RLock()
...
func (r *RTPStatsReceiver) ToProto() *conkit.RTPStats {
	r.lock.RLock()
	defer r.lock.RUnlock()
