...
func (t *Track) IsManaged() bool {
	return t.source != conkit.TrackSource_SCREEN_SHARE || t.isSimulcast
}

func (t *Track) ID() conkit.TrackID {
	return conkit.TrackID(t.downTrack.ID())
}

func (t *Track) PublisherID() conkit.ParticipantID {
