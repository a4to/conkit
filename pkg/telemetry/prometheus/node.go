...
import (
	...
	"github.com/a4to/protocol/utils/hwstats"
)

const (
	conkitNamespace string = "conkit"
...
func Init(nodeID string, nodeType conkit.NodeType) error {
...
func GetUpdatedNodeStats(prev *conkit.NodeStats, prevAverage *conkit.NodeStats) (*conkit.NodeStats, bool, error) {
